...
//types
import {FavouritesStackParamList} from '../../types/types.ts';
...
const Favourites = () => {
  ...
  const navigation =
    useNavigation<StackNavigationProp<FavouritesStackParamList>>();
      ...
      <SafeAreaView>
        ...
        <View style={mainStyles.center}>
          <WebView
            ...
            source={{uri: 'https://halalbooking.com/favourites'}}
            userAgent={'HB App'}
            ref={webviewRef}
